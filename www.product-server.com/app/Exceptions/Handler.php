...
class Handler extends ExceptionHandler
{
    ...
    protected $handles = [
        ...
        AuthException::class                 => 'handleAuthExceptionException',
    ...
    /**
     * Handle auth exception response
     *
     * @param AuthException $exception
     * @param $request
     * @return \Illuminate\Http\Response|\Laravel\Lumen\Http\ResponseFactory
     */
    protected function handleAuthExceptionException(AuthException $exception, $request)
    {
        return $this->ok($exception->all());
    }
